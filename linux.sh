...
sudo apt-get -y install build-essential g++ gfortran bzip2 libbz2-dev xorg-dev liblzma-dev libreadline-dev libpcre2-dev libpcre++-dev libcurl4-openssl-dev libpango1.0-dev libcairo2-dev default-jdk default-jre libomp-dev
